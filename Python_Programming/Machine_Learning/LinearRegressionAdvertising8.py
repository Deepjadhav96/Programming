...
def MarvellousRegression(Datapath):
    ...
    #Step7: Split the Dataset
    print(border)
    print("Step7: Split the Dataset")
    print(border)
    ...
    print(border)
    print("Step8: Create and Train the model")
    print(border)
    ...
    #"Step11: Display Coefficient
    print(border)
    print("Step11: Display Coefficient")
    print(border)
